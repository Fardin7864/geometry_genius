...
// Set inner text by id from input
...
function setInnerTextByIdFromText(textFildId,area){
    const inputFild = document.getElementById(textFildId);
    inputFild.innerText = area;
}
...
document.getElementById('btn-triangle').addEventListener('click',() => { 
    ...
    const result = (x * 0.5);
    setInnerTextByIdFromText('triangle-result',result);
...
document.getElementById('btn-rectangle').addEventListener('click',() => { 
    ...
    setInnerTextByIdFromText('rectangle-result',x);
 })
 ...
 document.getElementById('btn-parallelogram').addEventListener('click',() => { 
     ...
     setInnerTextByIdFromText('parallelogram-result',x);
  })
...
document.getElementById('btn-rhombus').addEventListener('click',() => { 
    ...
    const result = (x * 0.5);
    setInnerTextByIdFromText('rhombus-result',result);
...
document.getElementById('btn-pentagon').addEventListener('click',() => { 
    ...
    const result = (x * 0.5);
    setInnerTextByIdFromText('pentagon-result',result);
 })
...
document.getElementById('btn-ellipse').addEventListener('click',() => { 
   ...
   setInnerTextByIdFromText('ellipse-result',result);
